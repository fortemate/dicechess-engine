...
All CodeRabbit settings live in [`.coderabbit.yaml`](https://github.com/fortemate/dicechess-engine/blob/main/.coderabbit.yaml) at the repository root. The file uses the [v2 schema](https://coderabbit.ai/integrations/schema.v2.json) and is version-controlled alongside the codebase.
